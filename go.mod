module github.com/AlexZ33/iris-common-model

go 1.18

require (
	github.com/AlexZ33/iris-extend-helper v1.0.0
	github.com/AlexZ33/iris-extend-server v0.0.0-20230131063400-f80122516b4c
